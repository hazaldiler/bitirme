...
import 'package:kidstarter/entities/car.dart';
import 'package:kidstarter/widgets/page_header.dart';
import 'package:kidstarter/widgets/tile_card2.dart';

Future<List<CarEntity>> _fetchCar() async {
  String jsonString = await rootBundle.loadString('assets/data/car.json');
  final jsonParsed = json.decode(jsonString);

  return jsonParsed
      .map<CarEntity>((json) => new CarEntity.fromJson(json))
      .toList();
}
...
class _carState extends State<car> {
  Future<List<CarEntity>> _carFuture;
